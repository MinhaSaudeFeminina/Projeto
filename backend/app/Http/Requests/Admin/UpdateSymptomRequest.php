...
class UpdateSymptomRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'name' => ['sometimes', 'required', 'string', 'max:120', Rule::unique('symptoms', 'name')->ignore($symptom->id)],
            ...
            'orientation_text' => ['sometimes', 'nullable', 'string', 'max:2000'],
            'severity_alert_text' => ['sometimes', 'nullable', 'string', 'max:2000'],
