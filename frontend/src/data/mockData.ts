...
export const categories: ContentCategory[] = [
  ...
  { id: '3', name: 'Gravidez', description: 'Informações sobre gestação', color: '#FF9800', icon: 'Baby', order: 3, isActive: true },
...
export const lifeStages: LifeStage[] = [
  ...
  { id: '3', name: 'Tentando engravidar', description: 'Orientações para quem deseja engravidar', contentIds: [], reminderSuggestions: ['Ácido fólico', 'Consulta pré-concepcional'], warningSignals: ['Dificuldade para engravidar após 1 ano'], ubsOrientation: 'A UBS pode orientar sobre planejamento reprodutivo.', order: 3, status: 'rascunho' },
  { id: '4', name: 'Gestação e pós-parto', description: 'Acompanhamento durante a gravidez e puerpério', contentIds: [], reminderSuggestions: ['Pré-natal', 'Vacinas da gestante', 'Consulta pós-parto'], warningSignals: ['Sangramento na gravidez', 'Pressão alta'], ubsOrientation: 'O pré-natal é realizado na UBS. Inicie assim que souber da gravidez.', order: 4, status: 'rascunho' },
...
export const appUsers: AppUser[] = [
  ...
  { id: '2', name: 'Fernanda O.', email: 'fernanda@email.com', age: 35, lifeStage: 'Tentando engravidar', city: 'Rio de Janeiro', status: 'ativo', notificationsActive: true, lastAccess: '2026-03-18T20:00:00', createdAt: '2025-07-15' },
  ...
  { id: '6', name: 'Letícia P.', email: 'leticia@email.com', age: 30, lifeStage: 'Gestação e pós-parto', city: 'Salvador', status: 'ativo', notificationsActive: true, lastAccess: '2026-03-19T07:30:00', createdAt: '2025-08-12' },
